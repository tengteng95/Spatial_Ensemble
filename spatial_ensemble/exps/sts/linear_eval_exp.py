...
from spatial_ensemble.models import resnet_mbn as resnet
import torch.distributed as dist
from spatial_ensemble.exps.sts.base_exp import BaseExp
...
class Exp(BaseExp):
    ...
    def get_data_loader(self, batch_size, is_distributed):
        if "data_loader" not in self.__dict__:
            ...
            from spatial_ensemble.data.dataset import ImageNet
            from spatial_ensemble.data.transforms import typical_imagenet_transform
